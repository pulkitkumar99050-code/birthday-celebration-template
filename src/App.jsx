    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happiest birthdayy to u <span className="highlight"> My Golgappa!!</span>💗😍🎂
              </>
            ) : (
              <>
          ...
          <p>I have made something special for my favorite bahen…𖹭 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          ...
          <p className="final-subtitle"> That's all for now..𖹭</p>
        </section>
      </div>
